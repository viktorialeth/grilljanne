...
export default function Grillkurser() {
    ...
    <main className="catering-page">
      ...
      {showBreadcrumbs && (
        ...
        <div className="catering-content">
          <div className="text">
            <h2>Grillkurser i Göteborg</h2>
            <p>Vill du utveckla dina färdigheter vid grillen eller ge medarbetare och vänner en unik aktivitet? 
                Våra grillkurser i Göteborg leds av erfarna grillmästare och är perfekta för företag, grupper, 
                möhippor, svensexor eller kompisgäng som vill lära sig mer om grillning, BBQ och råvarukännedom.</p>
            <div className="menu-sub">Under kursen går vi igenom:</div>
              <ul>
                <li>Grilltekniker (direkt/indirekt värme, rökning, lågtemp)</li>
                <li>Köttkunskap och temperaturer</li>
                <li>Marinader, rubs, glaze och kryddning</li>
                <li>Grillning av kött, fisk, grönt och streetfood</li>
                <li>Säker hantering av grill och utrustning</li>
              </ul>
            <p>Ni får själva grilla och prova er fram under handledning. All utrustning, råvaror och grillar ingår.
                 Kursen kombinerar kunskap, praktiskt arbete och social samvaro – perfekt som teambuilding-aktivitet 
                 eller kul överraskning till någon som älskar grillning.</p>
            <button
          ...
          <div
            className="image"
            style={{ backgroundImage: `url(${IMAGES.grid9})` }}
          />
        </div>
      </section>
